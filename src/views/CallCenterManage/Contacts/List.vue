                ...
                <tr class="v-datatable-item">
                  ...
                  <td class="text-no-wrap text-right">
                    <v-btn
                      icon
                      small
                      :to="{ name: 'call_center_manager_contacts_edit', params: { contact_id: item.id } }"
                    >
...
export default Vue.extend({
  ...
  mounted () {
    ...
    if (this.$routerQuery.hasQuery('responsible_id')) {
      this.$refs.sGroupsAutocomplete.setDefault(this.$routerQuery.getQuery('responsible_id', 0))
    }
  },
